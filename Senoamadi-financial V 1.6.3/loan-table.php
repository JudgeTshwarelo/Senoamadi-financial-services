                    ...
                    <?php if ($loans->num_rows > 0): ?>
                        <?php while ($row = $loans->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="process_loan.php?id=<?= $row['id']; ?>&action=approve" style="color:green;">Approve</a> |
                                    <a href="process_loan.php?id=<?= $row['id']; ?>&action=reject" style="color:red;">Reject</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6">No pending loans</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
