...
<body>
    ...
    <div class="container">
        ...
        <h2>Pending Investment Applications</h2>
            ...
            <table>
                ...
                <tbody>
                    <?php if ($investments->num_rows > 0): ?>
                        <?php while ($row = $investments->fetch_assoc()): ?>
                            <tr>
                                <td><?= $row['id']; ?></td>
                                ...
                                <td>
                                    <input type="number" value="<?= $row['interest_rate']; ?>" min="0" step="0.01">%
                                </td>
                                <td>
                                    <a href="process_investment.php?id=<?= $row['id']; ?>&action=approve" style="color:green;">Approve</a> |
                                    <a href="process_investment.php?id=<?= $row['id']; ?>&action=reject" style="color:red;">Reject</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="7">No pending investments</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
